...
public static class ServicesExtensions
{
    ...
    private static IHostApplicationBuilder ConfigureApiServices(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped(typeof(IDAL<>), typeof(DomainDAL<>));
        ...
        builder.Services.AddScoped<IMessageBusConsumer, RabbitMqConsumer>();
        builder.Services.AddSingleton<IMessageService, OrderPlacedEventService>();
